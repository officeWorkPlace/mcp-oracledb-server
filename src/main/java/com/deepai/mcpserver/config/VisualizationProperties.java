...
public class VisualizationProperties {
    ...
    public String getDefaultFramework() { return defaultFramework; }
    public void setDefaultFramework(String defaultFramework) { this.defaultFramework = defaultFramework; }
    
    public boolean isAutoDetectColumns() { return autoDetectColumns; }
    ...
    public static class Chart {
        ...
        public Default getDefault() { return defaultSettings; }
        public void setDefault(Default defaultSettings) { this.defaultSettings = defaultSettings; }
    ...
    public static class Security {
        ...
        public boolean isSqlInjectionProtection() { return sqlInjectionProtection; }
        public void setSqlInjectionProtection(boolean sqlInjectionProtection) { this.sqlInjectionProtection = sqlInjectionProtection; }
        
        public String getAllowedTablesPattern() { return allowedTablesPattern; }
        public void setAllowedTablesPattern(String allowedTablesPattern) { this.allowedTablesPattern = allowedTablesPattern; }
        
        public String getBlockedTablesPattern() { return blockedTablesPattern; }
        public void setBlockedTablesPattern(String blockedTablesPattern) { this.blockedTablesPattern = blockedTablesPattern; }
    }
}