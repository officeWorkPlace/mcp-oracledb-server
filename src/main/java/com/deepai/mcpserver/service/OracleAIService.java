...
public class OracleAIService {
    ...
    @Tool(name = "oracle_vector_search",
          description = "Perform Oracle 23c native vector queries for similarity search")
    public Map<String, Object> performVectorSearch(
        @ToolParam(name = "tableName", required = true) String tableName,
        @ToolParam(name = "vectorColumn", required = true) String vectorColumn,
        @ToolParam(name = "queryVector", required = true) List<Double> queryVector,
        @ToolParam(name = "distanceMetric", required = false) String distanceMetric,
        @ToolParam(name = "topK", required = false) Integer topK,
        @ToolParam(name = "additionalColumns", required = false) List<String> additionalColumns) {
    ...
    @Tool(name = "oracle_vector_similarity",
          description = "Calculate vector similarity using VECTOR_DISTANCE functions")
    public Map<String, Object> calculateVectorSimilarity(
        @ToolParam(name = "vector1", required = true) List<Double> vector1,
        @ToolParam(name = "vector2", required = true) List<Double> vector2,
        @ToolParam(name = "distanceMetrics", required = false) List<String> distanceMetrics) {
    ...
    @Tool(name = "oracle_vector_clustering",
          description = "Perform vector grouping and clustering analysis")
    public Map<String, Object> performVectorClustering(
        @ToolParam(name = "tableName", required = true) String tableName,
        @ToolParam(name = "vectorColumn", required = true) String vectorColumn,
        @ToolParam(name = "clusterCount", required = false) Integer clusterCount,
        @ToolParam(name = "distanceMetric", required = false) String distanceMetric,
        @ToolParam(name = "identifierColumn", required = false) String identifierColumn) {
    ...
    @Tool(name = "oracle_vector_index",
          description = "Manage vector indexes for Oracle 23c vector search")
    public Map<String, Object> manageVectorIndex(
        ...
        @ToolParam(name = "vectorColumn", required = false) String vectorColumn,
        @ToolParam(name = "distanceMetric", required = false) String distanceMetric,
        @ToolParam(name = "indexParameters", required = false) Map<String, Object> indexParameters) {
    ...
    @Tool(name = "oracle_ai_analyze_document",
          description = "Analyze document content using AI for insights and patterns")
    public Map<String, Object> analyzeDocument(
        @ToolParam(name = "tableName", required = true) String tableName,
        @ToolParam(name = "documentColumn", required = true) String documentColumn,
        @ToolParam(name = "documentId", required = true) String documentId,
        @ToolParam(name = "analysisType", required = false) String analysisType,
        @ToolParam(name = "aiModel", required = false) String aiModel) {
        ...
        try {
            ...
            List<Map<String, Object>> topKeywords = wordFreq.entrySet().stream()
                ...
                .limit(10)
                .map(entry -> Map.of("keyword", entry.getKey(), "frequency", entry.getValue()))
    ...
    @Tool(name = "oracle_ai_generate_summary",
          description = "Generate AI-powered summaries of document content")
    public Map<String, Object> generateSummary(
        @ToolParam(name = "tableName", required = true) String tableName,
        @ToolParam(name = "documentColumn", required = true) String documentColumn,
        @ToolParam(name = "documentId", required = true) String documentId,
        @ToolParam(name = "summaryType", required = false) String summaryType,
        @ToolParam(name = "maxLength", required = false) Integer maxLength) {
    ...
    @Tool(name = "oracle_ai_content_classification",
          description = "Classify content using AI-powered categorization")
    public Map<String, Object> classifyContent(
        @ToolParam(name = "tableName", required = true) String tableName,
        @ToolParam(name = "contentColumn", required = true) String contentColumn,
        @ToolParam(name = "recordId", required = true) String recordId,
        @ToolParam(name = "categories", required = false) List<String> categories,
        @ToolParam(name = "confidence", required = false) Double confidenceThreshold) {
    ...
    @Tool(name = "oracle_ai_sql_generation",
          description = "Generate Oracle SQL from natural language descriptions")
    public Map<String, Object> generateSqlFromNaturalLanguage(
        @ToolParam(name = "naturalLanguageQuery", required = true) String naturalLanguageQuery,
        @ToolParam(name = "tableContext", required = false) List<String> tableContext,
        @ToolParam(name = "dialectOptimization", required = false) Boolean dialectOptimization) {
    ...
    @Tool(name = "oracle_ai_query_optimization",
          description = "AI-powered SQL query optimization and tuning")
    public Map<String, Object> optimizeQuery(
        @ToolParam(name = "sqlQuery", required = true) String sqlQuery,
        @ToolParam(name = "optimizationGoals", required = false) List<String> optimizationGoals,
        @ToolParam(name = "includeExplainPlan", required = false) Boolean includeExplainPlan) {
    ...
    @Tool(name = "oracle_ai_schema_design",
          description = "AI-powered Oracle schema design recommendations")
    public Map<String, Object> recommendSchemaDesign(
        @ToolParam(name = "businessRequirements", required = true) String businessRequirements,
        @ToolParam(name = "dataVolume", required = false) String dataVolume,
        @ToolParam(name = "performanceGoals", required = false) List<String> performanceGoals,
        @ToolParam(name = "includePartitioning", required = false) Boolean includePartitioning) {
